...
scr_seq_T25R0901_000:
	...
	LockAll
	FacePlayer
	NPCMsg msg_0591_T25R0901_00000
	TouchscreenMenuHide
...
_002E:
	NPCMsg msg_0591_T25R0901_00001
	WaitABPress
	CloseMsg
	...
	NPCMsg msg_0591_T25R0901_00002
	TouchscreenMenuHide
	GetMenuChoice VAR_SPECIAL_RESULT
	TouchscreenMenuShow
	Compare VAR_SPECIAL_RESULT, 0
...
_00B3:
	NPCMsg msg_0591_T25R0901_00005
	WaitButton
	CloseMsg
	ReleaseAll
	End
...
_00BE:
	NPCMsg msg_0591_T25R0901_00008
	WaitButton
	CloseMsg
	ReleaseAll
	End
...
_00C9:
	BufferPartyMonNick 0, VAR_SPECIAL_x8005
	NPCMsg msg_0591_T25R0901_00007
	WaitButton
	CloseMsg
	ReleaseAll
	End
...
_00D9:
	NPCMsg msg_0591_T25R0901_00003
	CloseMsg
	...
	GoToIfEq _011F
	BufferPartyMonNick 0, VAR_SPECIAL_x8005
	NPCMsg msg_0591_T25R0901_00004
	WaitButton
	CloseMsg
	ReleaseAll
	End
...
_011F:
	BufferPartyMonNick 0, VAR_SPECIAL_x8005
	NPCMsg msg_0591_T25R0901_00006
	WaitButton
	CloseMsg
	ReleaseAll
	End
